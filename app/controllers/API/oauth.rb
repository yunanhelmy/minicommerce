  ...
  class Oauth < Grape::API
    ...
    resources :oauth do
      ...
      params do
        ...
        requires :client_id, type: String, default: (Doorkeeper::Application.first.uid rescue nil)
        optional :client_secret, type: String, default: (Doorkeeper::Application.first.secret rescue nil)
